	...
	return (
		<View>
			...
			<View style={[styles.container, { backgroundColor: t.textInput }]}>
				...
				>
					<Animated.Text style={[styles.normalP, { color: t.text }, leftTextStyle]}>
						Normalny
					</Animated.Text>
				</Pressable>
				<View
				...
				>
					<Animated.Text style={[styles.highP, { color: t.text }, midTextStyle]}>
						Wysoki
					</Animated.Text>
				</Pressable>
				<View
				...
				>
					<Animated.Text style={[styles.criticalP, { color: t.text }, rightTextStyle]}>
						Krytyczny
					</Animated.Text>
				</Pressable>
			</View>
